module github.com/mulesoft-anypoint/muletracker-cli/cmd/apim

go 1.24.0

require (
	github.com/mulesoft-anypoint/anypoint-client-go/apim v0.3.1
	github.com/mulesoft-anypoint/anypoint-client-go/apim_contract v0.1.0
